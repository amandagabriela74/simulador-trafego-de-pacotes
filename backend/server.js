...
// Inicializa a rede como uma matriz 10x10 com valores nulos
...
const arquivoRedesSalvas = "redesSalvas.json";

// Carrega ou inicializa a rede
let rede = fs.existsSync(arquivoRede)
  ? JSON.parse(fs.readFileSync(arquivoRede, "utf8"))
  : inicializarRede();

// Carrega redes salvas ou inicializa
let redesSalvas = fs.existsSync(arquivoRedesSalvas)
  ? JSON.parse(fs.readFileSync(arquivoRedesSalvas, "utf8"))
  : [];
